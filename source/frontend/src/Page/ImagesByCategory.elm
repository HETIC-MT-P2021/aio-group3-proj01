module Page.ImagesByCategory exposing (Model, Msg, init, subscriptions, toSession, update, view)
...
getImages id =
    Http.get
        { url = "http://localhost:4000/api/category/images/" ++ (String.fromInt id)
